                ...
                <td>
                  <div class="pds-flex pds-gap-xs date" style="width: 256px">
                    <div class="pds-flex pds-gap-xs faux-input faux-input-start">
                      ...
                      <input type="text" aria-label="Start date of ${item.start === "11/11/1111" ? "forever" : item.start}" value=${item.start === "11/11/1111" ? "forever" : item.start} class="pds-flex-fill" />
                    </div>
                    to
                    <div class="pds-flex pds-gap-xs faux-input faux-input-end">
                      ...
                      <input type="text" aria-label="End date of ${item.end === "11/11/9999" ? "forever" : item.end}" value=${item.end === "11/11/9999" ? "forever" : item.end} class="pds-flex-fill" />
                    </div>
                  </div>
                </td>
                <td>
